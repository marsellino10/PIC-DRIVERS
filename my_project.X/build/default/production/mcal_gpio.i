...
unsigned char read_pit(port_name_t port_name,pins_num_t pin_num);
...
{
    unsigned char val;
    val = ((*port_reg[port_name]&(1<<pin_num)>>pin_num));
    return val;
}
...
void toggle_port(port_name_t port_name)
{
    *lat_reg[port_name] ^= *lat_reg[port_name];
}
